...
# it provides instructions and behavioural constraints that guide the LLM thoughout conversation 
...
def get_product_price(product: str) -> float:
    """Look uo the price of the product in the catalog."""  # Docstring
...
def apply_discount(price: float, discount_tier: str) -> float:
    ...
    Avalible discount tiers: bronze, silver, gold."""
    print(
...
def run_agent(question: str):
    ...
    tools_dict = {t.name: t for t in tools}  # Dictionary Comprehension
...
if __name__ == "__main__":
    ...
    print()
    result = run_agent("What is the price of a laptop after applyin a gold discount?")
